...
.. c:type:: PyArray_Descr
   ...
   .. c:member:: char flags
       ...
       .. c:function:: bool PyDataType_FLAGCHK(PyArray_Descr *dtype, int flags)

           Return true if all the given flags are set for the data-type
           object.

       .. c:function:: bool PyDataType_REFCHK(PyArray_Descr *dtype)
...
.. c:type:: PyArray_ArrFuncs
    ...
    .. c:member:: PyObject *castdict
        ...
        wrapped in a :c:type:`PyCObject *<PyCObject>` and keyed
        by the data-type number.
